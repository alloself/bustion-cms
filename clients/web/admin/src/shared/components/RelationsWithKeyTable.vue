...
<script lang="ts" setup generic="T extends IRelationWithKeyItem">
import { client } from "@/shared/api/axios";
import { useModuleStore } from "@/entities/module/store";
import {
  IRelationWithKeyItem,
  IRelationsWithKeyTableProps,
} from "@/shared/types";
...
const {
  ...
  showActions,
  itemTitle,
} = defineProps<IRelationsWithKeyTableProps<T>>();
...
const onCreate = (entitiy: T) => {
  emits("update:model-value", [...modelValue, {...entitiy,pivot:{value:''}}]);
